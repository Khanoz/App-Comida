...
import com.example.appcomida.dataClasses.userCart
...
object Utilities {
    ...
    private fun wazzabi(){
        ...
        wz.add(
            MenuItem("Sashimi corte fino atin",
            "",
    ...
    private fun taqueriaLeo(){
        ...
        leo.add(
            MenuItem("Torta Bistec de Res con Queso ",
            "",
            "",
        40)
        )
        leo.add(
            MenuItem("Sopes de Bistec",
            "",
            "",
        22)
        )
        leo.add(
            MenuItem("Agua de Horchata 1L",
            "",
            "",
        30)
        )
        leo.add(
            MenuItem("Quesadilla de Bistec",
            "",
            "",
        23)
        )
        leo.add(
            MenuItem("Agua de Jamaica 1L",
            "",
            "",
        30)
        )
        leo.add(
            MenuItem("Taco de Tinga",
            "",
            "Con tortilla de harina o tortilla normal, se sirven con cebolla y cilantro. ",
        13)
        )
        leo.add(
            MenuItem("Taco al Pastor ",
            "",
            "Con tortilla de harina o tortilla normal, se sirven con cebolla y cilantro. ",
        15)
        )
        leo.add(
            MenuItem("Gringa al Pastor ",
            "",
    ...
    private fun krispyKreme(){
        ...
        kk.add(
            MenuItem("Dona Glaseada Original",
    ...
    private fun pandaExpress(){
        ...
        pe.add(
            MenuItem("Camarones Crispy",
            "",
            "Crisp-golden butterflied shrimp.",
        70)
        )
        pe.add(
            MenuItem("Rollos Primavera",
            "",
    ...
    private fun lefate(){
        ...
        lf.add(
            MenuItem("Fettuccine Negro con Mariscos",
            "",
